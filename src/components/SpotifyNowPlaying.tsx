...
const SpotifyNowPlaying = () => {
    ...
    // If not playing, show fake/mock data for demonstration
    if (!data?.isPlaying) {
        const mockData = {
            isPlaying: true,
            title: "Kingslayer",
            ...
            songUrl: "https://open.spotify.com/track/4vAONtRJGPYipjfYXmkOfD",
        };

        return (
            <AnimatePresence mode="wait">
                <motion.a
                    key={mockData.songUrl}
                    href={mockData.songUrl}
                    target="_blank"
